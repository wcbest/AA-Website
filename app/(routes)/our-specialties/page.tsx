...
const businessBrokerageServices = [
  {
    id: "insurance",
    title: "Insurance",
    description: `With deep expertise in all insurance lines (Life, General, Health, Brokerage, Reinsurance), we offer an integrated approach to value creation for our insurance sector clients.`,
    href: "/insurance",
  },
  {
    id: "acturial-and-financial-modeling",
    title: "Acturial & Financial Modeling",
    description: `Our actuarial team leverages global expertise to create customized local solutions to our clients. We provide comprehensive actuarial solutions including Product Development, Pricing, Experience Studies & Assumption Development, Valuation & Financial Reporting
`,
    href: "/acturial-and-financial-modeling",
  },
  {
    id: "investment-and-asset-liability-management",
    title: "Investment & Asset Liability Management",
    description: `By understanding the emergence and characteristics of liabilities, we advise our clients on Liability-Driven Investment strategies that ensure invested assets are appropriate for the liabilities and capital it supports.
`,
  ...
  },
  {
    ...
    description: `Our Risk Management approach empowers our clients to embrace risk rather than retreat from it, Risk and Opportunity go hand-in-hand. We offer Defensive techniques that help our clients Identify, Assess, Mitigate, Monitor and Report on their business risks but also develop Offensive techniques that embed risk management in aggressive business development efforts.
`,
  ...
  },
  {
    id: "compliance",
    title: "Compliance",
    description: `Our Compliance practice helps organizations design, implement, and sustain effective compliance frameworks aligned with regulatory requirements and international best practices. We partner with clients to strengthen governance, promote ethical conduct, and build systems that support business integrity and long-term sustainability.
By combining global regulatory insight with practical implementation support, we enable our clients to meet complex compliance obligations while maintaining agility and competitive advantage.
`,
    href: "/compliance",
  },
];
