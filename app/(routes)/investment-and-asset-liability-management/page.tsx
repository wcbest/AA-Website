...
const businessBrokerageServices = [
  {
    ...
    description: `
We build customized investment frameworks that define risk-return objectives,
liquidity needs, and asset class allocation to achieve long-term performance goals.`,
    features: [
      "Buyer qualification",
      "Market matching",
      "Transaction support",
  ...
  },
  {
    ...
    description: `
We design diversified portfolios that optimize growth potential while maintaining
capital preservation across economic cycles.`,
    features: [
      "Business valuation",
      "Marketing strategy",
      "Buyer screening",
  ...
  },
  {
    ...
    description: `We identify short-term opportunities in global and regional markets to enhance
portfolio returns without deviating from strategic objectives.`,
    features: [
  ...
  },
  {
    ...
    description: `
We develop investment limit frameworks that balance opportunity and risk, ensuring
regulatory compliance and internal control.`,
  ...
  },
  {
    ...
    description: `We prepare comprehensive Investment Policy Statements (IPS) that document
governance, strategy, and decision-making parameters for institutional investors.`,
    features: [
      "Diverse portfolio",
      "Verified listings",
        ...
        <div className="mx-auto max-w-[90rem] px-4 md:px-8">
          <div className="mx-auto">
            <p className="font-thin text-3xl text-[#1E1E1E] leading-relaxed">
              We advise clients on aligning investments with liabilities through
              Liability-Driven Investment (LDI) strategies. Our approach
              integrates risk analytics, governance, and market insight to
              protect capital and enhance returns.
            </p>
          </div>
        </div>
      </section>
